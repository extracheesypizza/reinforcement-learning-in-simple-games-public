...
NUM_EPISODES_TEST = 2 # number of episodes for testing
mcts_plays_first = True # deciding whether MCTS is P1 or P2
...
if __name__ == "__main__":
    ...
    test_mcts(env, mcts_player=players[0], opponent_player=players[1], num_episodes=NUM_EPISODES_TEST, mcts_iterations=MCTS_ITERATIONS)